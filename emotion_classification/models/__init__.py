...
scorecard treat a TF-IDF SVM and a fine-tuned RoBERTa identically.
...
* :mod:`.classical`   — scikit-learn TF-IDF + LogReg / LinearSVM
* :mod:`.deep`        — PyTorch BiLSTM
* :mod:`.transformer` — HuggingFace BERT / RoBERTa fine-tuning
"""
